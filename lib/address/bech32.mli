...
(** [data] is 5-bit groups.
    @raise Invalid_argument if [hrp] is not 1..83 characters in ASCII 33..126,
    if any group is outside 0..31, or if the result would exceed
    [max_length] (default {!default_max_length}). *)
